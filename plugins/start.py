    ...
    for sub_channel_id in FORCE_SUB_CHANNEL_IDS.values():
        try:
            ...
            await message.reply_text(
                text="You are not Subscribed to these Channels @EminenceinShadowDub_1 @animecolony @joblessreincarnationx @AnArchdemonsDilemmadub and https://t.me/+Rf-8Hu_KBUY3Y2Y0 ",
