    ...
    for sub_channel_id in FORCE_SUB_CHANNEL_IDS.values():
        try:
            ...
            await message.reply_text(
                text="You are not Subscribed to these Channels @attackontitanseasonsdub   @EminenceinShadowDub    @risingofshieldheroseason2dual @RurouniKenshin2023dub   @imGivingthedisgracedNobleladydub  @AnimeColony @TheApothecaryDiariesdub ",
